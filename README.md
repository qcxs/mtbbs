...
详见：https://bbs.binmt.cc/thread-159149-1-1.html
可添加油猴或直接以js执行，集众多页面为一体，统一使用page参数控制分页。滚动加载下一页，手动加载上一页，页码跳转，地址栏无刷新更新。已适配：社区、导读、搜索、个人空间帖子/回复/留言、帖子评论、我的好友、积分明细、消息提醒。