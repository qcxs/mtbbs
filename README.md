...
这里是[qcxs/mtbbs](https://github.com/qcxs/mtbbs)，存储了**自用**适配[MT论坛](https://bbs.binmt.cc/)**移动端**的脚本、网站。初始只是个人为[Alook浏览器](https://www.alookweb.com/)编写一些脚本，存放在123盘中。经历了不断优化，有三种脚本成功入围[编程开发 - MT论坛](https://bbs.binmt.cc/forum.php?mod=forumdisplay&fid=42&filter=digest&digest=1)精华帖，现将脚本源码统一整理，存储在此仓库中，随缘更新。
